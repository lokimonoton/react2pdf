...
//window.ResponsiveBootstrapToolkit.use('Custom', config.ResponsiveBootstrapToolkitVisibilityDivs);
...
// config.chart.colorPrimary = window.tinycolor($ref.find(".chart .color-primary").css("color"));
// config.chart.colorSecondary = window.tinycolor($ref.find(".chart .color-secondary").css("color"));
$(function() {
	animate({
		name: 'flipInY',
	...
	setTimeout(function(){
		let $el = $('.error-card > .error-container');
...
function setSameHeights($container) {
	...
	let viewport = window.ResponsiveBootstrapToolkit.current();
	...
	$container.each(function() {
		...
		$items.each(function() {
			...
			let excludedStr = $(this).data('exclude') || '';
			let excluded = excludedStr.split(',');
...
$(function() {
    ...
    function drawFlotCharts() {
        ...
        //     label: "Sales 1",
        //     data: 21,
        //     color: window.tinycolor(config.chart.colorPrimary.toString()).lighten(20),
        // }, {
        //     label: "Sales 2",
        //     data: 15,
        //     color: window.tinycolor(config.chart.colorPrimary.toString()).lighten(10),
        // }, {
        //     label: "Sales 3",
        //     data: 7,
        //     color: window.tinycolor(config.chart.colorPrimary.toString()),
        // }, {
        //     label: "Sales 4",
        //     data: 52,
        //     color: window.tinycolor(config.chart.colorPrimary.toString()).darken(10),
        // }];
        ...
        let maximum = container.outerWidth() / 10 || 100;
...
$(function() {
    ...
    function drawMorrisCharts() {
        ...
        Morris.Area({
            ...
            resize: true,
            lineColors: [
                // window.tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
                // window.tinycolor(config.chart.colorPrimary.toString()).darken(10).toString(),
...
$(function() {
    ...
    let $dashboardSalesBreakdownChart = $('#dashboard-sales-breakdown-chart');
    ...
    $dashboardSalesBreakdownChart.empty();
        ...
        Morris.Donut({
            ...
            colors: [
                window.tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
                window.tinycolor(config.chart.colorPrimary.toString()).darken(8).toString(),
                config.chart.colorPrimary.toString()
            ],
        });

        let $sameheightContainer = $dashboardSalesBreakdownChart.closest(".sameheight-container");
...
$(function() {
    ...
    let $dashboardSalesMap = $('#dashboard-sales-map');
    ...
    function drawSalesMap() {
        ...
        let color = config.chart.colorPrimary.toHexString();
        let darkColor = window.tinycolor(config.chart.colorPrimary.toString()).darken(40).toHexString();
        let selectedColor = window.tinycolor(config.chart.colorPrimary.toString()).darken(10).toHexString();
...
$(function() {
	...
	$(".wyswyg").each(function() {
		...
		let editor = new Quill($editor.get(0), {
			theme: 'snow'
		});
...
$(function () {
	...
	let $app = $('#app');
	let $styleLink = $('#theme-style');
	let $customizeMenu = $('#customize-menu');

	// Color switcher
	let $customizeMenuColorBtns = $customizeMenu.find('.color-item');

	// Position switchers
	let $customizeMenuRadioBtns = $customizeMenu.find('.radio');
	...
	*************************************************/
	...
	function getThemeSettings() {
		let settings = (localStorage.getItem('themeSettings')) ? JSON.parse(localStorage.getItem('themeSettings')) : {};
